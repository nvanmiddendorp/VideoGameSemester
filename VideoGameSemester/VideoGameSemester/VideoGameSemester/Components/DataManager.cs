...
using FunctionalityLib.SpellClasses;
using FunctionalityLib.TalentClasses;
using FunctionalityLib.TrapClasses;
...
namespace VideoGameSemester.Components
{
    static class DataManager
    {
        ...
        static Dictionary<string, EntityData> monsters = new Dictionary<string, EntityData>();
        ...
        public static Dictionary<string, EntityData> MonsterData
        {
            get { return monsters; }
        }
        ...
        public static void ReadMonsterData(ContentManager Content)
        {
            string[] filenames = Directory.GetFiles(@"Content\Game\Monsters", "*.xnb");

            foreach (string name in filenames)
            {
                string filename = @"Game\Monsters\" + Path.GetFileNameWithoutExtension(name);
                EntityData data = Content.Load<EntityData>(filename);
                MonsterData.Add(data.EntityName, data);
            }
        }
